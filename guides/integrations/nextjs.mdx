...
export async function getPosts() {
  try {
    const raw = await fetch("https://api.marblecms.com/v1/posts", {
...
export async function getTags() {
  try {
    const raw = await fetch("https://api.marblecms.com/v1/tags", {
      headers: { Authorization: key },
    });
...
export async function getSinglePost(slug: string) {
  try {
    const raw = await fetch(`https://api.marblecms.com/v1/posts/${slug}`, {
      headers: { Authorization: key },
    });
...
export async function getCategories() {
  try {
    const raw = await fetch("https://api.marblecms.com/v1/categories", {
      headers: { Authorization: key },
    });
...
export async function getAuthors() {
  try {
    const raw = await fetch("https://api.marblecms.com/v1/authors", {
      headers: { Authorization: key },
    });
