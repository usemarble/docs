...
<CardGroup cols={2}>
<Card title="Posts" icon="file-text" href="/content/api/endpoint/posts">
  Get all published posts with pagination support.
</Card>

<Card title="Categories" icon="folder" href="/content/api/endpoint/categories">
  Browse all content categories with pagination.
</Card>

<Card title="Authors" icon="users" href="/content/api/endpoint/authors">
  List all authors with their associated content.
</Card>

<Card title="Tags" icon="tag" href="/content/api/endpoint/tags">
